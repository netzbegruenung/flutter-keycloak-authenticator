...
enum KeycloakExceptionType { notRegistered, badRequest, networkError, serverError, unknown }
...
class KeycloakClientException implements Exception {
  ...
  KeycloakClientException(this.message, {required this.type, required this.innerException});
}
